...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, ThemeToggle, LucideAngularModule, TranslateModule, Sidebar, ClickOutsideDirective, DockviewComponent], // ✅ Directiva añadida a los imports
