...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, ThemeToggle, LucideAngularModule, TranslateModule, Sidebar, ClickOutsideDirective, DockviewAngularComponent],
