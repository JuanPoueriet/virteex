import { Component, input, output, effect, ElementRef, viewChild, computed, ChangeDetectionStrategy } from '@angular/core';
...
export class UiModalComponent {
  ...
  hasFooterContent() {
    return (this.footerContent()?.nativeElement?.childNodes?.length || 0) > 0;
  }
